...
This is the source code for GPGPUSim+Ramulator simulator which is the GPGPUSim integrated with the Ramulator DRAM simulator. In this version, GPGPUSim uses Ramulator to silmulate the DRAM. 
